...
;c3d587
	...
	jsl.l DisplayMessage
	.db $A9,$13,$85,$00,$A9,$13,$85,$02,$22,$50,$25,$C6   ;C3D5B2
...
@lbl_C3D87B:
	...
	jsl.l DisplayMessage
	.db $E2,$20,$A9,$13,$85,$00,$A9,$1D,$85,$02,$22,$50   ;C3D890
	.db $25,$C6,$60                       ;C3D89C  
	sep #$20 ;A->8
	lda.b #$0A
	sta.b wTemp01
