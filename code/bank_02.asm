...
@lbl_C20E5A:
	...
	lda $7E8781,x                           ;C20E62
	.db $F0,$F8   ;C20E66
	bmi @lbl_C20E76                         ;C20E68
	lda $7E8731,x                           ;C20E6A
	bne @lbl_C20E76                         ;C20E6E
	sta $7E8781,x                           ;C20E70
	.db $80,$EA   ;C20E74
@lbl_C20E76:
	lda #$FF                                ;C20E76
...
@lbl_C22A45:
	...
	beq @lbl_C22A5C
	cpx #$13                                ;C22A4B
	beq @lbl_C22A53                         ;C22A4D
	cpy #$13                                ;C22A4F
	.db $D0,$09   ;C22A51
@lbl_C22A53:
	lda $01,s                               ;C22A53
	asl a                                   ;C22A55
	bcc @lbl_C22A5A                         ;C22A56
	lda #$FF                                ;C22A58
@lbl_C22A5A:
	sta $01,s                               ;C22A5A
@lbl_C22A5C:
...
@lbl_C22BC8:
	...
	lda $7E85A1,x                           ;C22BD9
	cmp #$3C                                ;C22BDD
	bcs @lbl_C22C1A                         ;C22BDF
	cmp #$28                                ;C22BE1
	beq @lbl_C22C1A                         ;C22BE3
	jsl $C3F65F                             ;C22BE5
	lda $00                                 ;C22BE9
	bmi @lbl_C22C17                         ;C22BEB
	lda #$E0                                ;C22BED
	sta $00                                 ;C22BEF
	lda $7E85A1,x                           ;C22BF1
	sta $01                                 ;C22BF5
...
@lbl_C22CD2:
	...
	ldx $00                                 ;C22CD7
	lda $7E85F1,x                           ;C22CD9
	beq @lbl_C22CEF                         ;C22CDD
	jsl $C3F65F                             ;C22CDF
	lda $00                                 ;C22CE3
	bit #$03                                ;C22CE5
	bne @lbl_C22CEF                         ;C22CE7
	stx $00                                 ;C22CE9
	jsl $C2816C                             ;C22CEB
@lbl_C22CEF:
	plp                                     ;C22CEF
...
@lbl_C22D01:
	...
	ldx $00                                 ;C22D06
	lda $7E85F1,x                           ;C22D08
	beq @lbl_C22D18                         ;C22D0C
	cmp #$0A                                ;C22D0E
	bcs @lbl_C22D18                         ;C22D10
	stz $01                                 ;C22D12
	jsl $C28215                             ;C22D14
@lbl_C22D18:
	plp                                     ;C22D18
...
func_C22E2D:
	...
	beq @lbl_C22E55
	cmp #$40                                ;C22E39
	bne @lbl_C22E47                         ;C22E3B
	jsl $C3F65F                             ;C22E3D
	lda $00                                 ;C22E41
	and #$1F                                ;C22E43
	bra @lbl_C22E4B                         ;C22E45
@lbl_C22E47:
	dec a                                   ;C22E47
	sta $899C                               ;C22E48
@lbl_C22E4B:
...
ApplyCharacterLevelGains:
	...
	bne @lbl_C235D9
	lda $01                                 ;C23586
	bmi @lbl_C235AC                         ;C23588
	clc                                     ;C2358A
	adc $862D,y                             ;C2358B
	cmp #$46                                ;C2358E
	bmi @lbl_C23594                         ;C23590
	lda #$46                                ;C23592
@lbl_C23594:
	tax                                     ;C23594
	lda $C2CA03,x                           ;C23595
	...
	lda $C2CA91,x                           ;C235A3
	sta $8669,y                             ;C235A7
	bra @lbl_C235D3                         ;C235AA
@lbl_C235AC:
	clc                                     ;C235AC
	adc $862D,y                             ;C235AD
	cmp #$01                                ;C235B0
	bpl @lbl_C235B6                         ;C235B2
	lda #$01                                ;C235B4
@lbl_C235B6:
	tax                                     ;C235B6
	lda $C2CA04,x                           ;C235B7
...
@lbl_C23661:
	...
	lda $8669,y                             ;C2366F
	sbc $C2CA92,x                           ;C23672
	bmi @lbl_C2367B                         ;C23676
	inx                                     ;C23678
	bra @lbl_C23661                         ;C23679
@lbl_C2367B:
	txa                                     ;C2367B
	sta $8619,y                             ;C2367C
	sta $862D,y                             ;C2367F
...
@lbl_C24279:
	...
	.db $D0,$36   ;C2427A
	lda $7E8970                             ;C2427C
	bmi @lbl_C24283                         ;C24280
	pha                                     ;C24282
@lbl_C24283:
	lda $7E8971                             ;C24283
	bmi @lbl_C2428A                         ;C24287
	pha                                     ;C24289
@lbl_C2428A:
	lda $7E8972                             ;C2428A
	bmi @lbl_C24291                         ;C2428E
	pha                                     ;C24290
@lbl_C24291:
	.db $80,$1A   ;C24291
	sta $00                                 ;C24293
...
@lbl_C242D4:
	...
	clc                                     ;C242DC
	adc #$0B                                ;C242DD
	bcc @lbl_C242E3                         ;C242DF
	lda #$FF                                ;C242E1
@lbl_C242E3:
	sta $7E86A4                             ;C242E3
	lda $7E8690                             ;C242E7
	asl a                                   ;C242EB
	bcc @lbl_C242F0                         ;C242EC
	lda #$FF                                ;C242EE
@lbl_C242F0:
	sta $7E8690                             ;C242F0
	plp                                     ;C242F4
...
@lbl_C24891:
	...
	plx                                     ;C248A0
	cpy $01                                 ;C248A1
	beq @lbl_C248AC                         ;C248A3
	inx                                     ;C248A5
	bra @lbl_C24891                         ;C248A6
@lbl_C248A8:
	stz $00                                 ;C248A8
	plp                                     ;C248AA
	rtl                                     ;C248AB
...
func_C24E11:
	...
	tax                                     ;C24E1A
	lda $7E85F1,x                           ;C24E1B
	beq @lbl_C24E5B                         ;C24E1F
	lda $7E85A1,x                           ;C24E21
	cmp #$0B                                ;C24E25
	bne @lbl_C24E5B                         ;C24E27
	lda $7E8781,x                           ;C24E29
	beq @lbl_C24E5B                         ;C24E2D
	lda $7E86E1,x                           ;C24E2F
	ora $7E8731,x                           ;C24E33
	ora $7E86B9,x                           ;C24E37
	ora $7E86A5,x                           ;C24E3B
	ora $7E86CD,x                           ;C24E3F
	ora $7E8849,x                           ;C24E43
	bne @lbl_C24E5B                         ;C24E47
	stx $00                                 ;C24E49
	jsl $C2785E                             ;C24E4B
	lda $00                                 ;C24E4F
	cmp #$13                                ;C24E51
	bne @lbl_C24E5B                         ;C24E53
	lda #$01                                ;C24E55
	sta $00                                 ;C24E57
	plp                                     ;C24E59
	rtl                                     ;C24E5A
...
@lbl_C25172:
	jsr $58DE                               ;C25172
	ldx $00                                 ;C25175
	bmi @lbl_C25163                         ;C25177
	lda $7E862C                             ;C25179
	cmp #$03                                ;C2517D
	bcs @lbl_C2518B                         ;C2517F
	phx                                     ;C25181
	jsl $C27C6D                             ;C25182
	plx                                     ;C25186
	lda $00                                 ;C25187
	beq @lbl_C25163                         ;C25189
@lbl_C2518B:
	txa                                     ;C2518B
	ora #$40                                ;C2518C
	bra @lbl_C25165                         ;C2518E
@lbl_C25190:
	cmp.b #$22
	bne @lbl_C2519F
	lda #$13                                ;C25194
...
@lbl_C253C3:
	...
	jsl $C21591                             ;C253CE
	plx                                     ;C253D2
	bmi @lbl_C2541A                         ;C253D3
	lda $7E8835,x                           ;C253D5
	bne @lbl_C2541A                         ;C253D9
	lda $7E8759,x                           ;C253DB
	cmp #$FE                                ;C253DF
	beq @lbl_C2541A                         ;C253E1
	cmp #$00                                ;C253E3
	bmi @lbl_C253EF                         ;C253E5
	sta $00                                 ;C253E7
	phx                                     ;C253E9
	jsl $C306F4                             ;C253EA
	plx                                     ;C253EE
...
func_C25520:
	...
	adc $7E867D,x                           ;C25555
	sta $7E867D,x                           ;C25559
	bra @lbl_C25575                         ;C2555D
@lbl_C2555F:
	dec a                                   ;C2555F
	bne @lbl_C2556F                         ;C25560
	lda $7E867D,x                           ;C25562
	lsr a                                   ;C25566
	adc #$00                                ;C25567
	sta $7E867D,x                           ;C25569
	bra @lbl_C25575                         ;C2556D
@lbl_C2556F:
	lda #$01                                ;C2556F
	sta $7E867D,x                           ;C25571
@lbl_C25575:
...
@lbl_C25578:
	...
	lda $7E862C                             ;C2557C
	dec a                                   ;C25580
	beq @lbl_C2559A                         ;C25581
	dec a                                   ;C25583
	bne @lbl_C2559F                         ;C25584
	lda $00                                 ;C25586
	bmi @lbl_C2559A                         ;C25588
@lbl_C2558A:
	sta $7E8730                             ;C2558A
	lda #$13                                ;C2558E
	sta $00                                 ;C25590
...
@lbl_C38A59:
	lda $7E85F1,x                           ;C38A59
	beq @lbl_C38A85                         ;C38A5D
	lda $7E8781,x                           ;C38A5F
	bmi @lbl_C38A85                         ;C38A63
	lda $7E85A1,x                           ;C38A65
	cmp $7E8996                             ;C38A69
	bne @lbl_C38A85                         ;C38A6D
	lda #$00                                ;C38A6F
	sta $7E8781,x                           ;C38A71
	stx $00                                 ;C38A75
	phx                                     ;C38A77
